...
void Start::draw() const
{
	...
	/// <summary>
	/// </summary>
	FontAsset(U"Score")(U"ゲームスタート！").drawAt(m_startButton.center(), Color(0, 0, 0));
	FontAsset(U"Score")(U"おわる").drawAt(m_exitButton.center(), Color(0, 0, 0));
	FontAsset(U"Score")(U"ルール説明").drawAt(m_ruleButton.center(), Color(0, 0, 0));
	FontAsset(U"Score")(U"クレジット").drawAt(m_creditButton.center(), Color(0,0,0));
